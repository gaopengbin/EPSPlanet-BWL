    ...
    <div class="epsplanet-panel-base" style="width: 450px">
        <el-form ref="form" label-width="70px">
            <el-form-item label="点标名称">
                <el-input v-model="name" placeholder="未命名点标绘" size="small"></el-input>
            </el-form-item>
            <el-form-item label="图标大小">
                <el-slider v-model="size" :min="1" :max="100" style="width: 200px" show-input :show-input-controls="false">
                </el-slider>
            </el-form-item>
            ...
            <el-form-item label="图标">
                <el-select v-model="makiIcon" placeholder="请选择">
                    <el-option v-for="item in makiIconList" :key="item.label" :label="item.label" :value="item.value">
                        <span style="float: left; color: black">{{ item.label }}</span>
                        <el-image style="float: right" :src="item.thumbnail" fit="fill"></el-image>
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="扩展文本">
                <el-input v-model="extText" placeholder="请输入内容" size="small"></el-input>
            </el-form-item>
            <el-row>
                <el-col :span="12">
                    <el-form-item label="文本字体">
                        <el-select v-model="extTextFontFamily" placeholder="请选择" style="width: 150px">
                ...
                <el-col :span="12">
                    <el-form-item label="文本大小">
                        <el-input-number v-model="extTextFontSize" :precision="0" :step="1" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="12">
                    <el-form-item label="左右偏移">
                        <el-input-number v-model="extTextPixelOffset[0]" :precision="0" :step="1" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="上下偏移">
                        <el-input-number v-model="extTextPixelOffset[1]" :precision="0" :step="1" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="6">
                    <el-form-item label="背景">
                        <el-color-picker v-model="fillColor" show-alpha @active-change="changeFillColor"></el-color-picker>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="边框">
                        <el-color-picker v-model="OutlineColor" show-alpha
                            @active-change="changeOutlineColor"></el-color-picker>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        <div class="tool-panel-button">
            <el-button size="small" @click="init" :disabled="editable">创建</el-button>
            <el-button size="small" @click="creating = !creating" :disabled="!editable">变更位置</el-button>
            <!-- <el-button size="small" @click="del">删除此点</el-button> -->
            <el-button size="small" @click="save" :disabled="!editable">保存</el-button>
        </div>
...
import { ElForm, ElFormItem, ElSlider, ElSelect, ElInput, ElOption, ElImage, ElInputNumber, ElColorPicker, ElButton } from 'element-plus'
    ...
    setup() {
        ...
        function getThumb(label) {
            return new Promise(async resolve => {
                ...
                let pic = await earth._pinBuilder.fromMakiIconId(label, Cesium.Color.TRANSPARENT, 48, Cesium.Color.TRANSPARENT)
